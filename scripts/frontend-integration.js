 ...
 * This file demonstrates how to integrate Powerampyarn with a web frontend
 */

// For React/Vue/Angular applications
export class PowerampyarnClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new PowerampyarnClient(provider, contractAddress);
