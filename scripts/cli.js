...
const contractABI = require("../artifacts/contracts/Powerampyarn.sol/Powerampyarn.json").abi;

program
    .name("powerampyarn-cli")
    .description("CLI tool for Powerampyarn smart contract")
    .version("1.0.0");
